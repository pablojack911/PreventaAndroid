...
/**
 * Created by Operador on 05/02/2016.
 */
public class CheckedLinearLayout extends LinearLayout implements Checkable {
    ...
    /**
     * Este metodo es el que cambia el estado de nuestro widget
    ...
    /**
     * Este metodo devuelve el estado de nuestro widget <img src="http://androcode.es/wp-includes/images/smilies/icon_smile.gif" alt=":)" class="wp-smiley">
    ...
    /**
     * Este metodo cambia el estado de nuestro widget
    ...
    /**
     * Este metodo es un poco mas complejo
     * Se encarga de combinar los diferentes "estados" de un widget
     * para informar a los drawables.
     *
     * Si nuestro widget esta "checked" le anadimos el estado CHECKED_STATE_SET
