...
import inteldev.android.presentation.BuscarArticulo;
import inteldev.android.presentation.ConvenioMayorista;
...
import inteldev.android.presentation.Folder.Folder;
...
public class FragmentArticulos extends Fragment
{
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (claveUnicaCabOper == null)
                            {
                                ...
                                cabOper.enviado = 0;
                                cabOper.domicilio = "";
                                controladorPedido.grabarCabOper(cabOper);
                            }
                            else
                            {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        //        ((TextView) rootView.rootView.findViewById(R.id.af_codigo_articulo)).setText(args.getString(CONSTANTES.CODIGO_ARTICULO));
