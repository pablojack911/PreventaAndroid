...
public class FragmentDetallePedido extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        assert args != null;
        idCliente = args.getString(CONSTANTES.ID_CLIENTE_SELECCIONADO);
//        ((TextView) rootView.findViewById(R.id.dpf_pedido)).setText(args.getString(CONSTANTES.DETALLE_PEDIDO_CLIENTE));
    ...
    //TODO: refrescar el total del pedido al eliminar un elemento del detalle

    private void lvPedidos()
    {
        ArrayList<DetallePedido> listadetallePedido = controladorPedido.consultarPedidos(idCliente);
