...
public class FragmentMotivoNoCompra extends Fragment
{
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_motivo_no_compra, container, false);
        Bundle args = getArguments();
        ((TextView) rootView.findViewById(R.id.mncf_motivo)).setText(args.getString(CONSTANTES.MOTIVO_NO_COMPRA_CLIENTE));
        return rootView;
    }
}
